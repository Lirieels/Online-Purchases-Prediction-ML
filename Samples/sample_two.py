...
def use_sample():
    ...
    print('-------------------------------------------------------------------------------')
    print('-----The details of each column of the dataset (before removing columns)-------')
    print('-------------------------------------------------------------------------------\n')
    print(online_shoppers_intention.describe())
    print('\n-------------------------------------------------------------------------------')
    print('-------------------------------------------------------------------------------\n')

    online_shoppers_intention = online_shoppers_intention.drop(
        columns=['OperatingSystems', 'Browser', 'Region', 'TrafficType', 'VisitorType'])

    # Print the details of the dataset
    print('-------------------------------------------------------------------------------')
    print('------The details of each column of the dataset (after removing columns)-------')
    print('-------------------------------------------------------------------------------\n')
    print(online_shoppers_intention.describe())
    print('\n-------------------------------------------------------------------------------')
    print('-------------------------------------------------------------------------------\n')
    ...
    train, valid, test = np.split(online_shoppers_intention.sample(frac=1),
                                  [int(0.6 * len(online_shoppers_intention)),
                                   int(0.8 * len(online_shoppers_intention))])
